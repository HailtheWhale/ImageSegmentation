...
img_mask_data_dir = "C:\\Users\\dmg20\\Research\\Computer_Vision\\images\\Base_images\\combined\\VOC_Combined_10_21_22\\SegmentationClass"
...
for img in range(0,len(img_mask_data_list)):
    ...
    save_path = "C:\\Users\\dmg20\\Research\\Computer_Vision\\images\\Base_images\\combined\\VOC_Combined_10_21_22\\Labelled_Imgs_Gray\\" + str(img_mask_data_list[img][0:17]) + ".jpg"
    print(save_path)
